...
import ConsumerGroupTopicView from "./ConsumerGroupTopicView";
                        ...
                        .map(([topic, data]) => {
                            return (
                                <tbody key={`${this.props.groupId}_${topic}`}>
                                    ...
                                    {
                                        data.map(assignment => (<ConsumerGroupTopicView key={`${this.props.groupId}_${assignment.partition}_topicview`}
